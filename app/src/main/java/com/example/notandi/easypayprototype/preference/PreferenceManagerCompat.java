...
package com.example.notandi.easypayprototype.preference;
...
public class PreferenceManagerCompat {
	...
	private static final String TAG = com.example.notandi.easypayprototype.preference.PreferenceManagerCompat.class.getSimpleName();
	 ...
	 */
	static void setFragment(final PreferenceManager manager, final com.example.notandi.easypayprototype.preference.PreferenceFragment fragment) {
		// stub
	}

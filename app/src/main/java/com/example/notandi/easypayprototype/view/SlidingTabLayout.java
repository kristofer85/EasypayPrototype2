...
public class SlidingTabLayout extends HorizontalScrollView {
    ...
    private final com.example.notandi.easypayprototype.view.SlidingTabStrip mTabStrip;
    ...
    public SlidingTabLayout(final Context context, final AttributeSet attrs, final int defStyle) {
        ...
        mTabStrip = new com.example.notandi.easypayprototype.view.SlidingTabStrip(context);
